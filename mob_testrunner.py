...
python_file = os.getcwd() + '\\testCases\\test_Mobile.py'
command = f'python -m pytest -s -v --disable-warnings -m mobile --alluredir={allure_report_path} {python_file} --env="{environment}"'
